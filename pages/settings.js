  ...
  async render(container, params) {
    ...
    try {
        ...
        email: `<div class="card" style="max-width:560px">
          ...
          <div style="display:flex;flex-direction:column;gap:14px">
            <div class="form-group">
              ...
              <input class="form-input" id="se-email" type="email" value="${escHtml(myProfile?.smtp_email ?? '')}" placeholder="you@workflow.app"/>
      ...
      window.testEmail = async () => {
        ...
        try {
          await window.smtpSend({ host: CFG.smtpHost, port: CFG.smtpPort, username: em, password: pw, to: em, from: em, subject: 'Workflow — Test Email', body: 'Your email credentials are configured correctly.' })
